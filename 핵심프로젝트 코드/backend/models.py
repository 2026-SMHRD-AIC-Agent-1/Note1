...
class AnswerAnalyses(SQLModel, table=True):
    ...
    scoring_version: Optional[str] = Field(default=None, max_length=80)
...
class FinalCoachings(SQLModel, table=True):
    ...
    # [2026-09 보완] 답변 분석 점수를 기준으로 세션 종합점수를 계산합니다.
    # 각 답변의 job_score와 answer_score를 평균한 값을 답변별 종합점수로 만들고,
    # 그 답변별 종합점수의 평균을 세션 overall_score로 저장합니다.
